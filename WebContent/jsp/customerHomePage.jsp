...
<head>
	...
	<title>Quick Transaction | BOBankLtd</title>
	...
	<div class="MainContainer">
           ...
           <div id="mainBody" class="MainBody" >
           		<div id="leftContainer" class="LeftContainer">
           			<h2 style="color:darkblue">Welcome to BOBankLtd</h2>
           		...
           		<div class="SideBarContainer">
                	<div class="QuickLinksBoard">
                        ...
                        <a href="${path }/jsp/sevices.jsp" style="color:green;font-size:14px;">About BOBankLtd Services</a><br>
                        <a href="${path }/jsp/aboutUs.jsp" style="color:green;font-size:14px;">About BOBankLtd</a><br>
                    	</marquee>
                	</div><br>
