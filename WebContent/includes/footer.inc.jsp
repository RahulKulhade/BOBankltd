...
<div class="FooterContainer">
    <div class ="FooterQuickLink">
        <table>
            ...
            <tr><td><a href="${path }/jsp/services.jsp">Services</a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="">BOB in the news</a></td></tr>
    ...
    <br><hr><span style="margin-left: 430px">Copyright © BOB THE BANK</span>
</div>